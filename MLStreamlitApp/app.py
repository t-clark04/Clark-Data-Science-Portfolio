...
def data_info():
    ...
    with st.expander("Want to learn more about the data?"):
        ...
        st.markdown("""
                 ...
                 To explore variables like player name, team, games played, field goals, and more, click the link to the full dataset above, or check out the first few rows of the dataset below:
                """)
